...
export const resourceOrgIcons = [
    {
        org: "unfoldingWord",
        icon: "https://images.prismic.io/unfolding-word/158ab69d-80e2-4bbe-831a-029cab21bc6f_uW-app-256.png?auto=compress,format&width=256",
    },
    {
        org: "Door43-Catalog",
        icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcVYa-G1vmVniiv3jrjiSKc9yVyxs8XwgXMlX7VQiv_HhwbWjZ",
    },
    {
        org: "WycliffeAssociates",
        icon: "https://content.bibletranslationtools.org/img/favicon.png",
    },
];
