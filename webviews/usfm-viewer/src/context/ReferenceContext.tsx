...
export const ReferenceContext = createContext<ReferenceContextType>({} as ReferenceContextType);

export function ReferenceContextProvider({ children }: { children: React.ReactNode }) {
    ...
    return <ReferenceContext.Provider value={contextValues}>{children}</ReferenceContext.Provider>;
}
