...
describe("CellContentDisplay - Lock/Unlock UI Behavior", () => {
    ...
    it("should not auto-start recording from audio button when locked", () => {
        const mockCell: QuillCellContent = {
            ...createMockCell("cell-1", "<p>Test content</p>", false),
            metadata: { isLocked: true } as any,
        };
    ...
    it("should not open editor from mic when locked on empty cell", () => {
        const mockCell: QuillCellContent = {
            ...createMockCell("cell-1", "", false),
            // Empty cell shows "Click to translate"
            cellContent: "",
            metadata: { isLocked: true } as any,
        };
