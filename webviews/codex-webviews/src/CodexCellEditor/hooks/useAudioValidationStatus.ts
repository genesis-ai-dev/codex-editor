...
import type { AudioValidationStatusIconProps } from "../AudioValidationStatusIcon";
...
export interface UseAudioValidationStatusResult {
    iconProps: AudioValidationStatusIconProps;
...
export function useAudioValidationStatus(
    ...
    const iconProps: AudioValidationStatusIconProps = {
