...
// Use the experimental parser functions
    ...
    const handleImport = async () => {
        ...
        try {
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                // Parse file
                // For target imports, only parse verses (skip headers, sections, etc.)
            ...
            if (isTranslationImport && alignContent && selectedSource) {
                ...
                try {
                    ...
                    // Use USFM-specific cell aligner that matches verses by verse number and chapter
                    // This ensures verses end up in the correct cells even if the target file is shorter
