...
export const registerSmartEditCommands = (context: vscode.ExtensionContext) => {
    ...
    if (!workspaceFolder) {
        console.warn("No workspace folder found, smart backtranslation will be disabled");
        return;
    }
    ...
    // Commands for SmartBacktranslation
    ...
    console.log("Smart Backtranslation commands registered");
};
