...
- Parallel Passages A tool to search the translation, as well as talk to an LLM about specific passages. (This is where you are!) They can search key words/phrases, or in the main editor they can click the ‘Pin’ icon, and it will show up as a search result here. There are three tabs: “Search” and “Chat” and "Silver Path". In Chat they can speak with the Assistant (you) about their progress in translating these things. In Silver Path they can speak with the Assistant about their progress in translating these things, and the Assistant will help them improve their translations. The Silver Path is a more advanced feature that allows the Assistant to learn how to better translate the entire project.
