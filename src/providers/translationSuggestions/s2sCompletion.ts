...
export async function s2sCompletion(language: string, vref: string, currentLineContent: string): Promise<string | null> {
    ...
    console.log(`Calling with forced_output_string set to ${currentLineContent} and reference set to ${reconstructedVref} (full book name: ${fullBookName})`);
