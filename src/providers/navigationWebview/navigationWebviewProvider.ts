...
export class NavigationWebviewProvider extends BaseWebviewProvider {
    ...
    protected getHtmlForWebview(webviewView: vscode.WebviewView): string {
        return getWebviewHtml(webviewView.webview, this._context, {
            ...
            csp: `default-src 'none'; img-src ${webviewView.webview.cspSource} https: data:; style-src ${webviewView.webview.cspSource} 'unsafe-inline'; script-src 'nonce-\${nonce}' https://static.cloudflareinsights.com; connect-src https://*.vscode-cdn.net https://*.frontierrnd.com https://*.posthog.com https://*.i.posthog.com; font-src ${webviewView.webview.cspSource};`,
            inlineStyles: `
