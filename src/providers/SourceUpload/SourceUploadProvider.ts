...
export class SourceUploadProvider implements vscode.CustomTextEditorProvider {
    public static register(context: vscode.ExtensionContext): vscode.Disposable {
        const provider = new SourceUploadProvider(context);
    ...
    private static readonly viewType = "sourceUploadProvider-scheme";

    constructor(private readonly context: vscode.ExtensionContext) {
        console.log("SourceUploadProvider constructor called", { context });
    }
