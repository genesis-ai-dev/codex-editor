...
export class DictionaryTablePanel {
    ...
    if (DictionaryTablePanel.currentPanel) {
      ...
      const panel = window.createWebviewPanel(
        ...
        // Extra panel configurations
        {
          ...
          localResourceRoots: [Uri.joinPath(extensionUri, "out"), Uri.joinPath(extensionUri, "webviews/editable-react-table/dist")],
        }
      );
  ...
  private _getWebviewContent(webview: Webview, extensionUri: Uri) {
    ...
    const stylesUri = getUri(webview, extensionUri, ["webviews", "editable-react-table", "dist", "assets", "index.css"]);
    // The JS file from the React build output
    const scriptUri = getUri(webview, extensionUri, ["webviews", "editable-react-table", "dist", "assets", "index.js"]);
