...
export class CreateNewProjectProvider implements vscode.WebviewViewProvider {
    private _webviewView: vscode.WebviewView | undefined;
    private _context: vscode.ExtensionContext | undefined;
    public static register(
        context: vscode.ExtensionContext,
    ): vscode.Disposable {
        const provider = new CreateNewProjectProvider(context);
        const providerRegistration = vscode.window.registerWebviewViewProvider(
            CreateNewProjectProvider.viewType,
            provider,
        );
        return providerRegistration;
    }

    private static readonly viewType = "scribe-vsc.obs-create-new-project";
    ...
    public async resolveWebviewView(
        ...
        webviewPanel.webview.onDidReceiveMessage(
            async (e: { type: MessageType; payload: unknown }) => {
                ...
                switch (e.type) {
                    case MessageType.createNewProject:
                    ...
                    default:
                        console.log("message received but unknown", e);
                        break;
                }
            },
        );
