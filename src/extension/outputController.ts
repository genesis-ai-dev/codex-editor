// This code is for handling the execution of the cell, and controlling what functions are called to set the output of the cell
...
export class NotebookKernel {
    readonly id: string = `${NAME}-kernel`;
    readonly notebookType: string = NAME;
    ...
    constructor(isInteractive?: boolean) {
        if (isInteractive) {
            this.id = `${NAME}-interactive-kernel`;
        ...
        this._controller.supportedLanguages = [LANGUAGE];
    ...
    private async _doExecution(cell: vscode.NotebookCell): Promise<void> {
        ...
        try {
            ...
            if (typeof exception === "string") {
                ...
                logger('hit some kind of exception');
            }
        }
